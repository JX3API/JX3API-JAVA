...
import jx3api.api.http.data.fraud.FraudDetailData;
...
import jx3api.api.http.data.idiom.IdiomSolitaireData;
...
import jx3api.api.http.data.member.MemberRecruitData;
import jx3api.api.http.data.member.MemberStudentData;
import jx3api.api.http.data.member.MemberTeacherData;
...
import jx3api.api.http.data.school.SchoolForceData;
import jx3api.api.http.data.school.SchoolMatrixData;
import jx3api.api.http.data.school.SchoolSkillsData;
...
import jx3api.api.http.data.trade.TradeRecordData;
